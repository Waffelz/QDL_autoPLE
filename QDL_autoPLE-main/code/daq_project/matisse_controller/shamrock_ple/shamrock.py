...
class Shamrock:
    ...
    def get_pixel_calibration_coefficients(self):
        """
        Returns
        -------
        float
        ...
        coeff2 = c_float()
        coeff3 = c_float()
        self.lib.ShamrockGetPixelCalibrationCoefficients(Shamrock.DEVICE_ID, pointer(coeff0), pointer(coeff1),
        ...
        cv = c_float()
        nump = c_int()
        # ShamrockGetCalibration(int device, float * CalibrationValues, int NumberPixels);
